...
*/
// mon creeTab avec mon formulaire
/*
function creeTab() {
...
function creeTab() {
	...
	for (var i = 0; i < 23; i++) {
		...
		tabl += "<td><form id=formuChoix> <input list=browsers onfocusout=change(this.id, this.value) name=browser style=border:none class=produit id=prod"+ i +"> <datalist id=browsers>";
		//tabl += "<td><form id=formuChoix> <input list=browsers onfocusout=test(this) name=browser style=border:none class=produit id=prod"+ i +"onchange='change(this.id, this.value)'> <datalist id=browsers>";
		//tabl += "<option selected></option>";
		for (var l = 0; l < aliments.length; l++){
			//tabl += "<option value=" + l + ">" + aliments[l] + "</option>";
			tabl += "<option value=" + aliments[l] + "></option>";
		}
		tabl += "</datalist></form></td><td id=ref" + i + "></form></td><td><input type=text style=border:none id=quantite name=produit></td>";
		// fin code liste
